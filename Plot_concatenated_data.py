...
def plot_average_time(data, output_path):
    ...
    percent_histogram = plt.figure(figsize=(1.5, 4.5))
    ...
    plt.subplots_adjust(hspace=.35, wspace=.35, bottom=0.3, left=0.35, right=0.87, top=0.92)
...
def plot_average_time_light_and_dark(data, output_path):
    ...
    total_time_wake = [wake_wt_pbs_light_mean, wake_het_pbs_light_mean, wake_het_syn21_light_mean, wake_het_syn20_light_mean,
                       wake_wt_pbs_dark_mean, wake_het_pbs_dark_mean, wake_het_syn21_dark_mean, wake_het_syn20_dark_mean]
    average_sd = [wake_wt_pbs_light_sd, wake_het_pbs_light_sd, wake_het_syn21_light_sd, wake_het_syn20_light_sd,
                  wake_wt_pbs_dark_sd, wake_het_pbs_dark_sd, wake_het_syn21_dark_sd, wake_het_syn20_dark_sd]
    bins = np.arange(8)

    #color = ['black', 'dimgrey', 'dodgerblue', 'LightSkyBlue', 'black', 'dimgrey', 'dodgerblue', 'LightSkyBlue']
    color = ['#363636', 'mediumseagreen', 'dodgerblue', 'crimson', '#363636', 'mediumseagreen', 'dodgerblue', 'crimson']

    percent_histogram = plt.figure(figsize=(3, 5))
    ax = percent_histogram.add_subplot(1, 1, 1)  # specify (nrows, ncols, axnum)
    ax.bar(bins, total_time_wake, color = color)
    ...
    ax.scatter(np.random.uniform(low=0.8, high=1.2, size=(len(wake_het_pbs_light))), np.array(wake_het_pbs_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=1.8, high=2.2, size=(len(wake_het_syn21_light))), np.array(wake_het_syn21_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=2.8, high=3.2, size=(len(wake_het_syn20_light))), np.array(wake_het_syn20_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=3.8, high=4.2, size=(len(wake_wt_pbs_dark))), np.array(wake_wt_pbs_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=4.8, high=5.2, size=(len(wake_het_pbs_dark))), np.array(wake_het_pbs_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=5.8, high=6.2, size=(len(wake_het_syn21_dark))), np.array(wake_het_syn21_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=6.8, high=7.2, size=(len(wake_het_syn20_dark))), np.array(wake_het_syn20_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    plt.errorbar(bins, total_time_wake, average_sd, fmt='none', ls='', marker='o', capsize=5, capthick=1, ecolor='black')
    plt.ylabel('Total time (minutes)', fontsize=12, labelpad=5)
    plt.tick_params(
        axis='both',  # changes apply to the x-axis
        which='both',  # both major and minor ticks are affected
        labelsize=12, length=5, width=1)
    plt.locator_params(axis='x', nbins=10)
    ax.set_xticklabels(['', 'WT - PBS', 'HET - PBS', 'HET - SYN21', 'HET - SYN20', 'WT - PBS', 'HET - PBS', 'HET - SYN21', 'HET - SYN20'])
    plt.xticks(rotation=70)
    ax.spines['top'].set_visible(False)
    ax.spines['right'].set_visible(False)
    ax.yaxis.set_ticks_position('left')
    plt.axhline(y=670, xmin =0.518, xmax=1, color='k', linewidth=5, alpha=0.85, zorder=0)
    ...
    ax.xaxis.set_ticks_position('bottom')
    plt.subplots_adjust(hspace=.35, wspace=.35, bottom=0.25, left=0.3, right=0.87, top=0.92)
    plt.savefig(output_path + '/total_time_wake_lightdark' + '.png', dpi=100)


    total_time_nrem = [nrem_wt_pbs_light_mean, nrem_het_pbs_light_mean, nrem_het_syn21_light_mean, nrem_het_syn20_light_mean,
                       nrem_wt_pbs_dark_mean, nrem_het_pbs_dark_mean, nrem_het_syn21_dark_mean, nrem_het_syn20_dark_mean]
    average_sd = [nrem_wt_pbs_light_sd, nrem_het_pbs_light_sd, nrem_het_syn21_light_sd, nrem_het_syn20_light_sd,
                  nrem_wt_pbs_dark_sd, nrem_het_pbs_dark_sd, nrem_het_syn21_dark_sd, nrem_het_syn20_dark_sd]
    bins = np.arange(8)
    ...
    ax.scatter(np.random.uniform(low=0.8, high=1.2, size=(len(nrem_het_pbs_light))), np.array(nrem_het_pbs_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=1.8, high=2.2, size=(len(nrem_het_syn21_light))), np.array(nrem_het_syn21_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=2.8, high=3.2, size=(len(nrem_het_syn20_light))), np.array(nrem_het_syn20_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=3.8, high=4.2, size=(len(nrem_wt_pbs_dark))), np.array(nrem_wt_pbs_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=4.8, high=5.2, size=(len(nrem_het_pbs_dark))), np.array(nrem_het_pbs_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=5.8, high=6.2, size=(len(nrem_het_syn21_dark))), np.array(nrem_het_syn21_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=6.8, high=7.2, size=(len(nrem_het_syn20_dark))), np.array(nrem_het_syn20_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ...
    ax.spines['right'].set_visible(False)
    ax.yaxis.set_ticks_position('left')
    plt.axhline(y=425, xmin =0.518, xmax=1, color='k', linewidth=5, alpha=0.85, zorder=0)
    #text(0.25, 0.95, 'Light', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes)
    #text(0.75, 0.95, 'Dark', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes, color = 'White')
    ...
    total_time_rem = [rem_wt_pbs_light_mean, rem_het_pbs_light_mean, rem_het_syn21_light_mean, rem_het_syn20_light_mean,
                       rem_wt_pbs_dark_mean, rem_het_pbs_dark_mean, rem_het_syn21_dark_mean, rem_het_syn20_dark_mean]
    average_sd = [rem_wt_pbs_light_sd, rem_het_pbs_light_sd, rem_het_syn21_light_sd, rem_het_syn20_light_sd,
                  rem_wt_pbs_dark_sd, rem_het_pbs_dark_sd, rem_het_syn21_dark_sd, rem_het_syn20_dark_sd]
    bins = np.arange(8)
    percent_histogram = plt.figure(figsize=(3, 5))
    ax = percent_histogram.add_subplot(1, 1, 1)  # specify (nrows, ncols, axnum)
    ...
    ax.scatter(np.random.uniform(low=0.8, high=1.2, size=(len(rem_het_pbs_light))), np.array(rem_het_pbs_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=1.8, high=2.2, size=(len(rem_het_syn21_light))), np.array(rem_het_syn21_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=2.8, high=3.2, size=(len(rem_het_syn20_light))), np.array(rem_het_syn20_light), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=3.8, high=4.2, size=(len(rem_wt_pbs_dark))), np.array(rem_wt_pbs_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=4.8, high=5.2, size=(len(rem_het_pbs_dark))), np.array(rem_het_pbs_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=5.8, high=6.2, size=(len(rem_het_syn21_dark))), np.array(rem_het_syn21_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    ax.scatter(np.random.uniform(low=6.8, high=7.2, size=(len(rem_het_syn20_dark))), np.array(rem_het_syn20_dark), edgecolors = "black", facecolors='white', linestyle='None', s=16)
...
def plot_average_bout_time(data, output_path):
    ...
    ax.scatter(np.random.uniform(low=2.8, high=3.2, size=(len(wake_het_syn20))), np.array(wake_het_syn20), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    plt.errorbar(bins, total_time_wake, average_sd, fmt='none', ls='', marker='o', capsize=5, capthick=1, ecolor='black')
    plt.ylabel('Bout time (seconds)', fontsize=12)
    plt.locator_params(axis='x', nbins=6)
    ax.set_xticklabels(['', 'WT - PBS', 'HET - PBS', 'HET - SYN21', 'HET - SYN20'])
    plt.xticks(rotation=70)
    ax.spines['top'].set_visible(False)
    ...
    ax.yaxis.set_ticks_position('left')
    ax.xaxis.set_ticks_position('bottom')
    plt.subplots_adjust(hspace=.35, wspace=.35, bottom=0.3, left=0.4, right=0.87, top=0.92)
...
def plot_average_bout_time_light_and_dark(data, output_path):
    ...
    ax.spines['right'].set_visible(False)
    ax.yaxis.set_ticks_position('left')
    plt.axhline(y=450, xmin =0.518, xmax=1, color='k', linewidth=5, alpha=0.85, zorder=0)
    #text(0.25, 0.95, 'Light', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes)
    #text(0.75, 0.95, 'Dark', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes, color = 'White')
...
def plot_average_bouts(data, output_path):
    ...
    ax.scatter(np.random.uniform(low=2.8, high=3.2, size=(len(wake_het_syn20))), np.array(wake_het_syn20), edgecolors = "black", facecolors='white', linestyle='None', s=16)
    plt.errorbar(bins, total_time_wake, average_sd, fmt='none', ls='', marker='o', capsize=5, capthick=1, ecolor='black')
    plt.ylabel('Bout number', fontsize=12)
    plt.locator_params(axis='x', nbins=6)
    ax.set_xticklabels(['', 'WT - PBS', 'HET - PBS', 'HET - SYN21', 'HET - SYN20'])
    plt.xticks(rotation=70)
    ax.spines['top'].set_visible(False)
...
def plot_average_bouts_light_and_dark(data, output_path):
    ...
    ax.spines['right'].set_visible(False)
    ax.yaxis.set_ticks_position('left')
    plt.axhline(y=600, xmin =0.518, xmax=1, color='k', linewidth=5, alpha=0.85, zorder=0)
    #text(0.25, 0.95, 'Light', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes)
    #text(0.75, 0.95, 'Dark', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes, color = 'White')
    ...
    ax.spines['right'].set_visible(False)
    ax.yaxis.set_ticks_position('left')
    plt.axhline(y=300, xmin =0.518, xmax=1, color='k', linewidth=5, alpha=0.85, zorder=0)
    #text(0.25, 0.95, 'Light', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes)
    #text(0.75, 0.95, 'Dark', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes, color = 'White')
    ...
    ax.spines['right'].set_visible(False)
    ax.yaxis.set_ticks_position('left')
    plt.axhline(y=90, xmin =0.518, xmax=1, color='k', linewidth=5, alpha=0.85, zorder=0)
    #text(0.25, 0.95, 'Light', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes)
    #text(0.75, 0.95, 'Dark', horizontalalignment='center',
         #verticalalignment='center', transform=ax.transAxes, color = 'White')
...
def plot_average_time_over_hours(df, output_path):
    ...
    plt.ylabel('Total time (minutes)', fontsize=12, labelpad=8)
