...
def concat_multi_dir():
    analysis_path = '/Volumes/Sarah/SYNGAPE8/OUTPUT/SYNGAPE8/12W/'

    local_output_path = '/Volumes/Sarah/SYNGAPE8/OUTPUT/SYNGAPE8/12W/analysis_all_animals.csv'
...
def concat_hourly_dir():
    ...
    local_output_path = '/Volumes/Sarah/SYNGAPE8/OUTPUT/SYNGAPE8/12W/analysis_hour_by_hour_all_animals.csv'
